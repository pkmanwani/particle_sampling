...
def process_folder(folder_name, const, num):
...
Constant=extract_constant(input('Name of your input simulation file(hit return for default): '))
# Perform resampling
number=int(input('Number of particles to resample: '))
FOLDER_NAME=input('Name of your RAW files folder: ')
FOLDER= process_folder(FOLDER_NAME, Constant, number)
...
while True:
    ...
    data, additional = extract_data(file_PATH, Constant)
